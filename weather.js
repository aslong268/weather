$(function() {
  var handleWeatherResponse = function(data) {
    ...
    var markup = "Today: " + data.currently.summary + ". Tomorrow: " + data.daily.data[1].summary + " The Next Day: " + data.daily.data[2].summary + " The Third Day: " + data.daily.data[3].summary + " ENJOY THE WEEK!";
